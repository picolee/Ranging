...
void Define_State_Machine( void )
{
    ...
    State_Machine_States[STATE_RX_START_CODE].stateTransitionTable[SM_MSG_CODE_DETECT]    = &State_Machine_States[STATE_RX_CONTINUE]; // Just for now
    State_Machine_States[STATE_RX_START_CODE].stateTransitionTable[SM_MSG_NO_CODE_DETECT] = &State_Machine_States[STATE_RX_CONTINUE];
    ...
    State_Machine_States[STATE_RX_CONTINUE].stateExecutionFunction                      = SM_Func_Continue_Rx;
